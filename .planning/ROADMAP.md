...
- [ ] **Phase 14: 多模态入口与参考素材表单** - 用户能在现有 Seedance create 操作中选择并配置官方多模态参考生视频模式。 (implementation executed 2026-05-19; verification blocked)
...
|-------|-----------|----------------|--------|-----------|
| 14. 多模态入口与参考素材表单 | v1.3 | 2/2 | Needs Verification | - |
