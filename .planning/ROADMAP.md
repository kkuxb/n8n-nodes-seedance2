...
Plans:
- [ ] 12-01-PLAN.md — Refactor the node description into mode-first video/image operation selectors and lock requested image field ordering with contract tests
...
| 12. Image Generation Mode & Operation UX Refactor | v1.2 | 0/2 | Planned | - |
