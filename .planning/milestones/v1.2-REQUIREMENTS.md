# Requirements Archive: v1.2 Seedream 5.0 lite image generation, UX iteration, and audit reconciliation

**Archived:** 2026-04-20
**Status:** SHIPPED

This archive captures the final shipped v1.2 requirement contract.
After milestone completion, `.planning/REQUIREMENTS.md` is removed until the next milestone is started.

## Requirement Outcomes

- `IMG-04` was refined during Phase 13 to match shipped public behavior: URL and binary are public UI inputs; base64/data URL remains internal compatibility fallback.
- `VAL-IMG-02` was formally traced and marked complete after retrospective verification confirmed the validator already enforced the intended size contract.
- Image `watermark` scope was updated from early planning assumptions to shipped behavior: default off, manually enableable.
